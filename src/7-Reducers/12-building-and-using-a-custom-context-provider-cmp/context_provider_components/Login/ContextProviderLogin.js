...
import classes from './ContextProviderLogin.module.css';
...
const ContextProviderLogin = (props) => {
  ...
  return (
    <ContextProviderCard className={classes.login}>
      <form onSubmit={submitHandler}>
        ...
        <div className={classes.actions}>
          <ContextProviderButton type="submit" className={classes.btn} disabled={!formIsValid}>
            Login
          </ContextProviderButton>
        </div>
      </form>
    </ContextProviderCard>
  );
